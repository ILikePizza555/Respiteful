...
public class MobEffectBuilder<T extends MobEffect, P> extends AbstractBuilder<MobEffect, T, P, MobEffectBuilder<T, P>> {
    public static final ProviderType<RegistrateTagsProvider.IntrinsicImpl<MobEffect>> MOB_EFFECT_TAGS = ProviderType
        .register("tags/mob_effect", type -> (parent, event) -> new RegistrateTagsProvider.IntrinsicImpl<>(
            parent,
            type,
            "mob_effect",
     ...
     * instead.
     *
     * @param langKeyProvider A function to get the translation key from the entry
